...
struct device d1 = { 1, 14, 19, 0, 0 };
struct device d2 = { 2, 27, 23, 0, 0 };
struct device d3 = { 3, 26, 18, 0, 0 };
struct device d4 = { 4, 25, 5, 0, 0 };
